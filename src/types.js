 ...
 * @property {() => Promise<{cancelled: number, remainingTracked: number, partialFills?: number, partialFillOrderIds?: string[], partialFillsCost?: number, unbookedFills?: Array<{orderId: string, filledSize: number, cost: number}>}>} cancelAllLadderOrders
