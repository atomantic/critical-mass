 ...
 * @property {() => Promise<{cancelled: number, remainingTracked: number, partialFills?: number, partialFillOrderIds?: string[], partialFillsCost?: number, unbookedFills?: Array<{orderId: string, cost: number}>}>} cancelAllLadderOrders
