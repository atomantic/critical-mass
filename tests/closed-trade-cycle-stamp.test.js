...
// actually wrote.
//
// Disk safety: throwaway pair '__testcyclestamp__' lives under a disposable
// temp root that is removed in after().
...
const isolatedData = createIsolatedDataDir('cm-cycle-stamp-test');
